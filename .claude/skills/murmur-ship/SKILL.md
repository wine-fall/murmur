...
4. **Verify acceptance.** Run the real thing and show evidence. Sensory criteria (sounds human, feels like radio, type-and-reply flows) → a **checklist for the user to run**, not self-declared.
