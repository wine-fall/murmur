...
- `search_music(query: str, limit: int) -> {candidates: [TrackCandidate...]}` — wraps `MusicProvider.search`. It **executes** a search; it does not recommend. Which catalogues it may search is spec 14 §2.4's business.
