...
// spec 14 §5.14, on a scrubbed copy of one listener's real snapshots
// (test/fixtures/taste, see its README): generated strings cannot show
// whether the budget survives real title widths and real list sizes.
describe('renderTasteDigest on the real snapshots', () => {
  ...
  it('gives the songs at least thirty of the listener\'s 186 kept tracks', () => {
    expect(line('Songs they keep')!.split(' · ').length).toBeGreaterThanOrEqual(30)
  })
